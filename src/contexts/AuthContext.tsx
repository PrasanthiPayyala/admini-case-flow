...
const SEED_USERS: DemoUser[] = [
  ...
  { id: "USR/DNO2", name: "B. Sridhar Rao", email: "dept.legalcell@lcms.local", mobile: "9000000040", role: "Department Nodal Officer", department: "Collectorate Legal Cell", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:05" },
  { id: "USR/DNO3", name: "K. Sandhya Rani", email: "dept.landrecords@lcms.local", mobile: "9000000041", role: "Department Nodal Officer", department: "Land Records", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:10" },
  { id: "USR/DNO4", name: "P. Ramesh Babu", email: "dept.tahsildar@lcms.local", mobile: "9000000042", role: "Department Nodal Officer", department: "Tahsildar Office", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:15" },
  { id: "USR/DNO5", name: "M. Anand Kumar", email: "dept.survey@lcms.local", mobile: "9000000043", role: "Department Nodal Officer", department: "Survey & Settlement", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:20" },
  { id: "USR/DNO6", name: "G. Srinivas Reddy", email: "dept.municipal@lcms.local", mobile: "9000000044", role: "Department Nodal Officer", department: "Municipal Administration", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:25" },
  { id: "USR/DNO7", name: "V. Lakshmi Prasanna", email: "dept.panchayat@lcms.local", mobile: "9000000045", role: "Department Nodal Officer", department: "Panchayat Raj", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:30" },
  { id: "USR/DNO8", name: "T. Ravi Shankar", email: "dept.randb@lcms.local", mobile: "9000000046", role: "Department Nodal Officer", department: "Roads & Buildings", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:35" },
  { id: "USR/DNO9", name: "S. Naga Raju", email: "dept.irrigation@lcms.local", mobile: "9000000047", role: "Department Nodal Officer", department: "Irrigation", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:40" },
  { id: "USR/DN10", name: "K. Sujatha", email: "dept.education@lcms.local", mobile: "9000000048", role: "Department Nodal Officer", department: "Education Department", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:45" },
