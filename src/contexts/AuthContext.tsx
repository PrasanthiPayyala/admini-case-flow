...
const SEED_USERS: DemoUser[] = [
  ...
  { id: "USR/DC01", name: "Sri Anurag Jayanthi, IAS", email: "collector@lcms.local", mobile: "9000000003", role: "District Collector", department: "Collectorate Legal Cell", mandal: "All", password: "demo123", status: "Active", lastLogin: "2026-04-13 09:15" },
