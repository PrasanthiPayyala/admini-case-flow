...
const DEMO_GROUPS: { section: string; accounts: { email: string; role: string }[] }[] = [
  ...
  { section: "DEPARTMENT NODAL OFFICERS", accounts: [
    { email: "dept.legalcell@lcms.local", role: "Collectorate Legal Cell" },
    { email: "dept.revenue@lcms.local", role: "Revenue Department" },
    { email: "dept.landrecords@lcms.local", role: "Land Records" },
    { email: "dept.tahsildar@lcms.local", role: "Tahsildar Office" },
    { email: "dept.survey@lcms.local", role: "Survey & Settlement" },
    { email: "dept.municipal@lcms.local", role: "Municipal Administration" },
    { email: "dept.panchayat@lcms.local", role: "Panchayat Raj" },
    { email: "dept.randb@lcms.local", role: "Roads & Buildings" },
    { email: "dept.irrigation@lcms.local", role: "Irrigation" },
    { email: "dept.education@lcms.local", role: "Education Department" },
  ]},
  { section: "MANDALS (TAHSILDAR)", accounts: [
    { email: "tahsildar.bhongir@lcms.local", role: "Bhongir" },
    { email: "tahsildar.choutuppal@lcms.local", role: "Choutuppal" },
    { email: "tahsildar.alair@lcms.local", role: "Alair" },
    { email: "tahsildar.yadagirigutta@lcms.local", role: "Yadagirigutta" },
  ]},
